        ...
        <Fragment>
            <div className="panel-body">
                ...
                <label
                    ...
                    Remember me</label>
                <p className="aa-lost-password"><a href="https://www.free-css.com/free-css-templates">Lost your password?</a></p>
                /
            </div>
        </Fragment>
    )
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="aa-checkout-single-bill">
                            <textarea
                                // @ts-ignore
                                cols="8" rows="3">Address*</textarea>
                        </div>
                    </div>
                </div>
                <div className="row">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="aa-checkout-single-bill">
                            <textarea
                                // @ts-ignore
                                cols="8" rows="3">Special Notes</textarea>
                        </div>
                    </div>
                </div>
            </div>
